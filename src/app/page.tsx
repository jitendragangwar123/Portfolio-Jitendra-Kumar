...
import Head from "../app/components/terminal/Head";
import Body from "../app/components/terminal/Body";
...
const Home = () => {
  ...
  const onNewSubmit = (cmd: string) => {
    if (cmd === "y") {
      ...
      toast.success("You are Redirecting to my portfolio");
    ...
    <div className="w-screen h-screen bg-color1 font-trLarabie">
      ...
      {Ctx.isNew ? (
        <div className="w-screen h-screen flex justify-center items-center">
          <div className="max-w-[30rem] max-h-[12rem] w-[96vw] h-auto bg-color1 rounded-2xl shadow-xl shadow-gray-800 terminal-Container border-[0.1rem] border-color3 fixed text-white p-4 flex flex-col gap-3 justify-center items-center">
        ...
        <>
          {Ctx.closed && (
            <div
              className="text-white absolute bottom-[5rem] left-[50%]"
              style={{
          ...
          <div
            className="bg-color1 rounded-2xl shadow-xl shadow-gray-800 terminal-Container border-[0.1rem] border-color3 fixed"
            style={{
